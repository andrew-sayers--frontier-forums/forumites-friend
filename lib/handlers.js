    ...
    return {
        ...
        forumdisplay: function() {
            ...
            observe_once( '#community', function() {
                $('.navbar').first().parent().append( '<span class="navbar">&gt; <a href="' + location + '" title="shareable link for this forum">[permalink]</a></span>' );
            });
        ...
        search: function() {
            ...
            observe_once( '#inlinemodform', function() {
                ...
                $('.navbar').first().parent().append( '<span class="navbar">&gt; <a href="' + '/search.php?' + query.join('&') + '" title="shareable link for this search">[permalink]</a></span>' );
        ...
        showthread: function() {
            observe_once( '.navbar a[href^="/showthread.php?t="],a[href^="printthread.php"]', function() {
                ...
                // permalink:
                $('.navbar').first().parent().append( '<span class="navbar">&gt; <a href="showthread.php?t=' + thread_id + '" title="shareable link for this thread">[permalink]</a></span>' );
                ...
                get_variables( 'super-ignore-users', 'ignored-threads', function(do_super_ignore, ignored_threads) {
		            ...
		            '</td>' +
	                    '</tr>' +
                            '<tr>' +
                            '<td id="who-posted" class="vbmenu_option vbmenu_option_alink" style="cursor: default;">' +
                                '<img alt="Who posted?" src="skins/frontier/StatusIcon/thread.gif" class="inlineimg" title="Who posted?">' +
                                '<a href="http://forums.frontier.co.uk/misc.php?do=whoposted&amp;t=' + thread_id + '">Who posted in this thread?</a>' +
		            '</td>' +
	                    '</tr>'
                        );
                        $('#subscribe-ignore,#who-posted')
                            .mouseover(function() { this.className = 'vbmenu_hilite vbmenu_hilite_alink'; this.setAttribute( 'style', "cursor: pointer;" ); })
                            .mouseout (function() { this.className = 'vbmenu_option vbmenu_option_alink'; this.setAttribute( 'style', "cursor: default;" ); })
                    });
                        ...
                        $('#posts .page').each(function() {
                            ...
                            if ( $(this).has( '.smallfont a[href^="profile.php?userlist=ignore&do=removelist&u="]' ).length ) {
                                ...
                                if ( reply_box ) {
                                    ...
                                    reply_box.prepend( '<a style="float: left; margin-left: 1em; margin-top: 4px" title="shareable link for this post" href="/showthread.php?p=' + post_id + '#post' + post_id + '">[permalink]</a>' );
                                    if ( name ) {
